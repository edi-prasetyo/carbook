                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($list_seller->is_active == 0) : ?>
                                <a class="btn btn-success btn-sm" href="<?php echo base_url('admin/seller/activated/' . $list_seller->id); ?>"><i class="fas fa-user-times"></i> Activated</a>
                            <?php else : ?>
                                <a class="btn btn-danger btn-sm" href="<?php echo base_url('admin/seller/banned/' . $list_seller->id); ?>"><i class="fas fa-user-times"></i> Banned</a>
