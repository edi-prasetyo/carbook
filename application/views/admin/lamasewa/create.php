    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                //Form Open
                echo form_open('admin/lamasewa',  array('class' => 'needs-validation', 'novalidate' => 'novalidate'));
                ?>

                <div class="form-group">
                    <label>Durasi</label>
                    <input type="number" class="form-control" name="lama_sewa" placeholder="Durasi Sewa" required>
                    <div class="invalid-feedback">Field Durasi Sewa tidak boleh kosong</div>
                </div>
