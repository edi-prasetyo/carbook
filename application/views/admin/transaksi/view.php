        ...
        <div class="row">
            ...
            <?php if ($transaksi->tipe_pembayaran == "Cash" && $transaksi->status_bayar == "Pending") : ?>
                <div class="col  d-grid gap-2">
                    <a href="<?php echo base_url('admin/transaksi/process/' . $transaksi->id); ?>" class="btn btn-success"><i class="fa fa-check"></i> Konfirmasi Order</a>
                </div>
                <div class="col d-grid gap-2">
                    <a href="<?php echo base_url('admin/transaksi/cancel/' . $transaksi->id); ?>" class="btn btn-danger"><i class="fa fa-times"></i> Batalkan Pesanan</a>
                </div>
            <?php elseif ($transaksi->tipe_pembayaran == "Cash" && $transaksi->status_bayar == "Process") : ?>
                <a href="<?php echo base_url('admin/transaksi/cancel/' . $transaksi->id); ?>" class="btn btn-danger d-grid gap-2"><i class="fa fa-times"></i> Batalkan Pesanan</a>
                <a href="<?php echo base_url('admin/transaksi/confirm/' . $transaksi->id); ?>" class="btn btn-success d-grid gap-2"><i class="fa fa-times"></i> Selesai</a>
            ...
            <?php else : ?>
                ...
                <div class="col-md-8">
                    ...
                    <?php elseif ($transaksi->bukti_bayar == NULL) : ?>
