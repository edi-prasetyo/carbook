    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                //Form Open
                echo form_open(base_url('admin/merek'));
                ?>

                <div class="form-group">
                    <label>Nama Merek</label>
                    <input type="text" class="form-control" name="merek_name" placeholder="Nama Merek">
                    <?php echo form_error('merek_name', '<small class="text-danger">', '</small>'); ?>
                </div>
