    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                //Form Open
                echo form_open(base_url('admin/jenismobil'));
                ?>

                <div class="form-group">
                    <label>Nama Jenis mobil</label>
                    <input type="text" class="form-control" name="jenismobil_name" placeholder="Nama Jenismobil">
                    <?php echo form_error('jenismobil_name', '<small class="text-danger">', '</small>'); ?>
                </div>
