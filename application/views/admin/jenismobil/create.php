    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                //Form Open
                echo form_open('admin/jenismobil',  array('class' => 'needs-validation', 'novalidate' => 'novalidate'));
                ?>

                <div class="form-group">
                    <label>Nama Jenis mobil</label>
                    <input type="text" class="form-control" name="jenismobil_name" placeholder="Nama Jenis mobil" required>
