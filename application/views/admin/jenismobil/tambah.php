  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        //Form Open
        echo form_open(base_url('admin/jenismobil'),$attribut);
        ?>

        <div class="form-group">
           <label>Nama Jenismobil</label>
             <input type="text" class="form-control" name="nama_jenismobil" placeholder="Nama Jenismobil" required="required">
        </div>
