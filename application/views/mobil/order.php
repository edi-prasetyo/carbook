      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <i class="fa fa-briefcase"></i> <?php echo $listpaket->kap_bagasi ?> Koper<br>
              <i class="fa fa-bookmark"></i> <?php echo $listpaket->nama_paket ?><br>
              <i class="fa fa-address-book"></i> Termasuk Supir<br>
            </div>
          </div>
        </div>
        <div class="card-footer text-light bg-danger">
          <h3 class="d-flex">
            ...
            <div class="ml-auto">
              Rp. <?php echo number_format($listpaket->harga, '0', ',', '.') ?>
            </div>
          </h3>
        </div>
      </div>
