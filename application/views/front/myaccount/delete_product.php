<?php if ($this->session->userdata('id')) : ?>
    ...
    <div class="modal fade" id="Delete<?php echo $myproducts->id ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda Yakin Ingin Menghapus Data Artkel <b><?php echo $myproducts->product_name ?></b>?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Batal</button>
                    <a href="<?php echo base_url('myaccount/delete/' . $myproducts->id) ?>" class="btn btn-danger pull-right"><i class="fa fa-close"></i> Ya, Hapus Artikel</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
