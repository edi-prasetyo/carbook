      ...
      <div class="p-3 osahan-profile mt-5">
         <div class="bg-white rounded shadow-sm mt-n5">
            <div class="d-flex align-items-center border-bottom p-3">
               <div class="left mr-3">
                  <img width="50%" src="<?php echo base_url('assets/img/avatars/' . $user->user_image); ?>" class="rounded-circle">
               </div>
               <div class="right">
                  ...
                  <p><a class="btn btn-sm btn-outline btn-info" href="<?php echo base_url('myaccount/update'); ?>">Edit</a> </p>
               </div>
            </div>
